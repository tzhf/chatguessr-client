...
<template>
  <li
    class="m-d relative bg-neutral-900 rounded-lg border border-neutral-700 p-2 scale-[0.98] hover:scale-[1] active:scale-[0.98] will-change-transform transition-transform cursor-pointer list-none"
  >
