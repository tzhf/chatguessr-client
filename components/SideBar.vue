<template>
	<aside>
		<div class="sticky">
			...
			<h5 class="heading__text">The original <a href="https://www.geoguessr.com" target="_blank">GeoGuessr</a> Twitch
				Chatbot</h5>
			<div class="container">
			...
			<section class="card m-2 text-center">
				...
				<div class="flex mx-2">
					...
					<button @click="linuxDownload" class="btn btn-sep bordered-success icon-linux">Linux
			...
			<section class="card m-2 text-center">
				<h2>Help us</h2>
				<p>ChatGuessr is free, any help is greatly appreciated and encourages us to maintain and improve the
					application.</p>
