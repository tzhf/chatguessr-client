<template>
    <section class="flex flex-col mx-auto sm:mx-0 gap-1 text-center">
        ...
        <span class="text-xs font-bold">version 2.3.0</span>
...
const winDownload = () => {
    window.open("https://github.com/tzhf/chatguessr/releases/download/v2.3.0/ChatGuessr-2.3.0.Setup.exe", "_blank");
}
const macOSDownload = () => {
    window.open("https://github.com/tzhf/chatguessr/releases/download/v2.3.0/ChatGuessr-darwin-x64-2.3.0.zip", "_blank");
}
const linuxDownload = () => {
    window.open("https://github.com/tzhf/chatguessr/releases/download/v2.3.0/chatguessr_2.3.0_amd64.deb", "_blank");
}
</script>
<style>
.btn-sep:before {
