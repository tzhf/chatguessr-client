  ...
  <section>
    ...
    <UiCard class="mb-6">
      ...
      <span class="flex flex-wrap gap-1">
        <UiBadge>!flag &lt;country code | country name&gt;</UiBadge>
        <UiBadge>!flag random</UiBadge>
        <UiBadge>!flag none</UiBadge>
      </span>
    </UiCard>

    <div
      class="grid grid-cols-1 sm:grid-cols-[repeat(2,_1fr)] lg:grid-cols-[repeat(4,_1fr)] gap-1.5 pb-6"
    >
    ...
    <div class="grid grid-cols-1 sm:grid-cols-[repeat(2,_1fr)] lg:grid-cols-[repeat(4,_1fr)] gap-1.5">
      <Flag
        v-for="nonTerritorial in NonTerritorialCodes"
        :flag="nonTerritorial"
        @click="copyToClipboard(nonTerritorial.code)"
      />
    </div>
  </section>
</template>
