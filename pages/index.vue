<template>
    <main>
        ...
        <section class="flex flex-col md:flex-row gap-2 my-10">
            <ReleaseNotes class="md:basis-4/5" />
            <Contributors class="flex-1" />
        </section>

        <section class="flex flex-col md:flex-row gap-x-2 gap-y-5 mb-10">
            <div class="flex-1">
                <h3 class="text-2xl font-bold text-center mb-3">How to install ?</h3>
                <div class="card">
                    <ol>
                        <li>Download &amp; install ChatGuessr</li>
                        <li>
                            Log in using your Twitch <strong>bot account</strong>.<br>
                            <small>Using a bot account is recommended for security and to prevent your main
                                account's
                        ...
                        <li>
                            ...
                            <small>
                                ...The bot should now be talking in your chat. Your chatguessr link will be
                                generated.
                    ...
                    <div class="card mt-5 p-3">
                        ...
                        <small>
                            ...
                            <p>
                                To fix that, click <span class="highlight">"Forgot my password"</span>, then fill in the
                                email
                                address linked to your Facebook/Google account.
                            </p>
                            <p>You will receive a mail to set a proper Geoguessr password.</p>
                            <p>Then, you will be able to connect via the native Geoguessr page with your email and your
                                new
                                password.</p>
                        </small>
                    </div>
            ...
            <div class="flex-1">
                <h3 class="text-2xl font-bold text-center mb-3">How to play ?</h3>
                <div class="card flex flex-col gap-2 mb-2">
                    <p class="text-center mb-3">All you need is a Twitch account, no GeoGuessr account required.</p>
                    <ol class="mb-6">
                        <li>Get the map link from the streamer (usually <span class="badge bg-primary">!cg</span>)
                        </li>
                    ...
                    <p class="text-center font-bold">Alternatively, if you can't or don't want to login :</p>
                    <ol>
                        <li>
                        ...
                        <li>
                            Paste
                            <pre>ctrl+v</pre> the whole command in chat without editing <br />
