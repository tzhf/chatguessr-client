export const countryCodes = [
    ...
    { code: "auaboriginal", names: "Aboriginal" },
    { code: "aw", names: "Aruba" },
    ...
    { code: "frbre", names: "Brittany, Bretagne" },
    ...
    { code: "ussr", names: "USSR, Soviet Union" },
    { code: "uy", names: "Uruguay" },
    { code: "uz", names: "Uzbekistan" },
    { code: "va", names: "Vatican, Holy See" },
...
export const NonTerritorialCodes = [
    { code: "lgbt", names: "Rainbow, Pride" },
    { code: "trans", names: "Transgender" },
    { code: "pirate", names: "Pirate, Jolly Roger" },
    { code: "checkered", names: "Checkered, Racing" },
    { code: "black", names: "Black" },
    { code: "white", names: "White" },
];
